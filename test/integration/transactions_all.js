...
describe('integration tests: transactions all', function() {
  this.timeout(50000);
   
  it('when requests transactions all than should return success response with transactions all', function(done) {
