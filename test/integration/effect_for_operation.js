...
const itemId = testConfig.operations.id;

describe('integration tests: effect for operation', function() {
  this.timeout(50000);
   
  it('when requests effect for operation than should return success response with effect', function(done) {
