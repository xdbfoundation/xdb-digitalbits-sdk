...
describe('integration tests: Offer for Account', function() {
   
  it('when requests Offer for Account than should return success response with Offer for Account', function(done) {
    let server;
