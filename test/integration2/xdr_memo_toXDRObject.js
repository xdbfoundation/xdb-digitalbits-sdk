...
describe('integration tests WIP: xdr memo toXDRObject', function() {
  let transaction
  let blob
  ...
  it('when requests xdr memo toXDRObject than should return success response', function(done) {
    let server;

    const requestHandler = (request, response) => {
      let xdrTestResult = DigitalBitsSdk.Memo.toXDRObject()
