...
describe('integration tests WIP: xdr memo fromXDRObject', function() {
  let transaction
  let blob
  ...
  it('when requests xdr memo fromXDRObject than should return success response', function(done) {
    let server;

    const requestHandler = (request, response) => {
      let xdrTestResult = DigitalBitsSdk.Memo.fromXDRObject()
