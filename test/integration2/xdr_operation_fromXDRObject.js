...
describe('integration tests WIP: xdr operation fromXDRObject', function() {
  let transaction
  let blob
  ...
  it('when requests xdr operation fromXDRObject than should return success response', function(done) {
    let server;

    const requestHandler = (request, response) => {
      let xdrTestResult = DigitalBitsSdk.Operation.fromXDRObject()
