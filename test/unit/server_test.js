    ...
    describe('requests a sub resource', function(done) {
      let transactionsResponse = {
        _links: {
          self: {
            href:
              'https://frontier.testnet.digitalbits.io/transactions?order=desc\u0026limit=1\u0026cursor='
          },
          next: {
            href:
              'https://frontier.testnet.digitalbits.io/transactions?order=desc\u0026limit=1\u0026cursor=34156680904183808'
          },
          prev: {
            href:
              'https://frontier.testnet.digitalbits.io/transactions?order=asc\u0026limit=1\u0026cursor=34156680904183808'
          }
        },
        _embedded: {
          records: [
            {
              _links: {
                self: {
                  href:
                    'https://frontier.testnet.digitalbits.io/transactions/c585b8764b28be678c482f8b6e87e76e4b5f28043c53f4dcb7b724b4b2efebc1'
                },
                account: {
                  href:
                    'https://frontier.testnet.digitalbits.io/accounts/GBURK32BMC7XORYES62HDKY7VTA5MO7JYBDH7KTML4EPN4BV2MIRQOVR'
                },
                ledger: {
                  href: 'https://frontier.testnet.digitalbits.io/ledgers/7952722'
                },
                operations: {
                  href:
                    'https://frontier.testnet.digitalbits.io/transactions/c585b8764b28be678c482f8b6e87e76e4b5f28043c53f4dcb7b724b4b2efebc1/operations{?cursor,limit,order}',
                  templated: true
                },
                effects: {
                  href:
                    'https://frontier.testnet.digitalbits.io/transactions/c585b8764b28be678c482f8b6e87e76e4b5f28043c53f4dcb7b724b4b2efebc1/effects{?cursor,limit,order}',
                  templated: true
                },
                precedes: {
                  href:
                    'https://frontier.testnet.digitalbits.io/transactions?order=asc\u0026cursor=34156680904183808'
                },
                succeeds: {
                  href:
                    'https://frontier.testnet.digitalbits.io/transactions?order=desc\u0026cursor=34156680904183808'
                }
              },
              id:
    ...
    describe('PathsCallBuilder', function() {
      ...
      it('requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://frontier-live.digitalbits.io:1337/paths?destination_account=GAEDTJ4PPEFVW5XV2S7LUXBEHNQMX5Q2GM562RJGOQG7GVCE5H3HIB4V&source_account=GARSFJNXJIHO6ULUBK3DBYKVSIZE7SC72S5DYBCHU7DKL22UXKVD7MXP&destination_amount=20.0&destination_asset_type=credit_alphanum4&destination_asset_code=EUR&destination_asset_issuer=GDSBCQO34HWPGUGQSP3QBFEXVTSR2PW46UIGTHVWGWJGQKH3AFNHXHXN'
            )
          )
    ...
    describe('TradeAggregationCallBuilder', function() {
      let tradeAggregationResponse = {
        _links: {
          self: {
            href:
              'https://frontier.testnet.digitalbits.io/trade_aggregations?base_asset_type=native\u0026counter_asset_type=credit_alphanum4\u0026counter_asset_code=BTC\u0026counter_asset_issuer=GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH\u0026start_time=1512689100000\u0026end_time=1512775500000\u0026resolution=300000'
          },
          next: {
            href:
              'https://frontier.testnet.digitalbits.io/trade_aggregations?base_asset_type=native\u0026counter_asset_code=BTC\u0026counter_asset_issuer=GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH\u0026counter_asset_type=credit_alphanum4\u0026end_time=1512775500000\u0026resolution=300000\u0026start_time=1512765000000'
          },
          prev: {
            href: ''
          }
