...
const BASE_URL = "https://frontier-live.digitalbits.io:1337";
const LP_URL = BASE_URL + "/liquidity_pools"


describe('/liquidity_pools tests', function() {
  beforeEach(function() {
    this.server = new DigitalBitsSdk.Server(BASE_URL);
  ...
  const EURT = new DigitalBitsSdk.Asset("EURT", "GAP5LETOV6YIE62YAM56STDANPRDO7ZFDBGSNHJQIYGGKSMOZAHOOS2S")
  const PHP  = new DigitalBitsSdk.Asset("PHP",  "GAP5LETOV6YIE62YAM56STDANPRDO7ZFDBGSNHJQIYGGKSMOZAHOOS2S")
  ...
  describe('filters', function() {
    const testCases = [
      {
        assets: [DigitalBitsSdk.Asset.native()],
