 ...
 * @see [All Payments](https://developers.digitalbits.io/frontier/reference/endpoints/payments-all.html)
 * @constructor
 * @extends CallBuilder
...
> {
   ...
   * @see [Payments for Account](https://developers.digitalbits.io/frontier/reference/endpoints/payments-for-account.html)
   ...
   * @see [Payments for Ledger](https://developers.digitalbits.io/frontier/reference/endpoints/payments-for-ledger.html)
   ...
   * @see [Payments for Transaction](https://developers.digitalbits.io/frontier/reference/endpoints/payments-for-transaction.html)
