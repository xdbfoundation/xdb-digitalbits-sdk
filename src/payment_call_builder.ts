 ...
 * @see [All Payments](https://developers.digitalbits.io/api/resources/payments/)
 * @constructor
 * @extends CallBuilder
...
> {
   ...
   * @see [Payments for Account](https://developers.digitalbits.io/api/resources/accounts/payments/)
   ...
   * @see [Payments for Ledger](https://developers.digitalbits.io/api/resources/ledgers/payments/)
   ...
   * @see [Payments for Transaction](https://developers.digitalbits.io/api/resources/transactions/payments/)
