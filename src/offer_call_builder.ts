 ...
 *
 * @see [Offers](https://developers.digitalbits.io/api/resources/offers/)
...
> {
   ...
   * @see [Offer Details](https://developers.digitalbits.io/api/resources/offers/single/)
   ...
   *
   * @see [Offers](https://developers.digitalbits.io/api/resources/accounts/offers/)
   ...
   * @see [Offers](https://developers.digitalbits.io/api/resources/offers/list/)
   * @see Asset
