 ...
 *
 *     "horizon.futurenet.xdbchain.com": {
...
FrontierAxiosClient.interceptors.response.use(
  function interceptorFrontierResponse(response: AxiosResponse) {
...
export default FrontierAxiosClient;
 ...
 * @param {string} hostname Hostname of a Frontier server.
