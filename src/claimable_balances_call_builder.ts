 ...
 *
 * @see [Claimable Balances](https://developers.digitalbits.io/frontier/reference/claimablebalances.html)
...
> {
   ...
   *
   * @see [Claimable Balance Details](https://developers.digitalbits.io/frontier/reference/claimablebalances-single.html)
