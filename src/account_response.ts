...
import { Account as BaseAccount, MuxedAccount } from "digitalbits-base";
...
export class AccountResponse {
  ...
  /**
   * Get DigitalBits account public key ex. `GB3KJPLFUYN5VL6R3GU3EGCGVCKFDSD7BEDX42HWG5BWFKB3KQGJJRMA`
