...
import { Asset, StrKey, Transaction, xdr } from "digitalbits-base";
...
/**
 * Server handles the network connection to a Frontier
...
export class Server {
   ...
   * @returns {PathCallBuilder} New {@link PathCallBuilder} object configured with the current Frontier server configuration.
   */
  public paths(
    source: string,
    destination: string,
