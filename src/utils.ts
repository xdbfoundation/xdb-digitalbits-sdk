...
export namespace Utils {
   ...
   * let challenge = Utils.buildChallengeTx(serverKeyPair, "client-digitalbits-account-id", "SDF", 300, Networks.TESTNET)
  ...
  /**
   * Verifies if a transaction is a valid SEP0010
   ...
   * @param {string} serverAccountID The server's digitalbits account.
   * @param {string} [networkPassphrase] The network passphrase.
   * @example
   * import { Utils, Networks }  from 'digitalbits-sdk'
   *
